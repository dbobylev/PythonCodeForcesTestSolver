...
class CodeForcesTask():
    def __init__(self, task_num, task_char):
        ...
        self.testcase_directory_name = 'problemset_tests'
        self.testcase_file_name = f'{self.testcase_directory_name}/{self.str_task_num}_{task_char}.json'
        self.solve_directory_name = 'problemset'
        self.solve_file_name = f'{self.solve_directory_name}/{self.str_task_num}_{task_char}.txt'
        ...
        if not os.path.exists(self.solve_directory_name):
            os.makedirs(self.solve_directory_name)